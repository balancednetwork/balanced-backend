"""
This was an attempt at breaking this function up more. A diligent GPT-aided effort
 would be
"""
...
#     from balanced_backend.tables.utils import PoolSeriesTableType, TokenSeriesTableType
#
#
...
#
#
# def get_token_series_min_interval(
#         session: 'Session',
#         pool_series: 'SeriesTable',
#         pool_table: 'PoolSeriesTableType',
#         token_table: 'TokenSeriesTableType',
# ) -> (int, int):
#     # Get last records
...
#
#     return token_time, last_token_series.timestamp
#
#
# def get_token_series_values(start: int, pool_table, token_table) -> PoolSeriesTableType:
...
#         get_token_series(session=session, pool_series=ts)
#
